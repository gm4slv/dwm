...
static const int user_bh            = 30;        /* 0 measn that dwm will calculate bar, =>1 means dwm will user_bh as bar height */
...
static const char col_yellow[]      = "#c4a000";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_yellow, col_gray1, col_gray2 },
